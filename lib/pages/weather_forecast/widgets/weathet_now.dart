...
class WeatherNow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(_bloc.state.weatherFavList[page].name,
          ...
          children: [
            Padding(
              ...
              child: SvgPicture.asset(
                "assets/icons/conditions/${_bloc.state.weatherFavList[page].icon}.svg",
                width: 100,
                height: 100,
              ),
            ),
            Column(
              children: [
                Text(_bloc.state.weatherFavList[page].daily[0].dt,
                    style: theme.textTheme.headline1),
                Text("${_bloc.state.weatherFavList[page].temp}°",
                    style: theme.textTheme.headline1?.copyWith(fontSize: 60)),
                Text(_bloc.state.weatherFavList[page].description,
                    style: theme.textTheme.headline1),
              ],
            ),
          ],
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text("${_bloc.state.weatherFavList[page].wind} m/s\nWind",
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                      "${(_bloc.state.weatherFavList[page].hourly[0].pop * 100).round()}%\nChance of rain",
                      style: theme.textTheme.bodyText1),
                ],
              ),
            ],
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text(
                      "${_bloc.state.weatherFavList[page].pressure} hPa\nPressure",
                      style: theme.textTheme.bodyText1),
                ],
              ),
              Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                        "${_bloc.state.weatherFavList[page].humidity}% \nHumidity",
                        style: theme.textTheme.bodyText1),
                  ),
                ],
              ),
